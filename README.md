# `Stellite, by Jinx`
`WARNING! DUE TO A REPEATED AND ONGOING LACK OF TROUBLESHOOTING SKILL BY USERS ASKING QUESTIONS IN THE DISCORD, THIS PROJECT IS *NOT* FOR USERS WITH LITTLE TO NO PROGRAMMING KNOWLEDGE!`
